...
BACKEND_FILE='install-rum-retail-prerequisites.sh'
...
FUNCTIONS_FILE_REPO="https://raw.githubusercontent.com/nikhilgoenkatech/retailapp/master/install-retail-rum-prerequisites.sh"
